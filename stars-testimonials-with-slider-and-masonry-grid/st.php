...
Version: 3.3.5
License: GPLv3
Text Domain: stars-testimonials-with-slider-and-masonry-grid
...
define('PREMIO_TESTIMONIAL_PLUGIN_VERSION', '3.3.5');
        ...
        if (isset($submenu[$subMenuKey])) {
            ...
            if (isset($submenu[$subMenuKey][$key][0])) {
                $submenu[$subMenuKey][$key][0] = '<span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">'
                    ...
                    . '</svg></span> ' . esc_html__( 'Upgrade to Pro', 'stars-testimonials-with-slider-and-masonry-grid' );
            }
        }
    }
