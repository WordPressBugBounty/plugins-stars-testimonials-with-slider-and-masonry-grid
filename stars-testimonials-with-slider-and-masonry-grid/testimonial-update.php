...
<div class="wrap">
    ...
    <div class="testimonial-page">
        <div class="testimonial-title"><?php esc_html_e('Update testimonial', 'stars-testimonials-with-slider-and-masonry-grid'); ?></div>
            ...
            <form action="<?php echo esc_url( admin_url() ) ?>" id="add_testimonial_item" method="post" >
                <div class="tst-form-field">
                    <div class="tst-form-field-left">
                        <label for="post_title"><?php esc_html_e('Client name:', 'stars-testimonials-with-slider-and-masonry-grid'); ?></label>
                    </div>
                    <div class="tst-form-field-right">
                        <input type="text" value="<?php echo esc_attr($post->post_title) ?>" class="required" data-label="<?php echo esc_attr__( 'Client name', 'stars-testimonials-with-slider-and-masonry-grid' ); ?>" name="post_title" id="post_title" placeholder="<?php echo esc_attr__( 'Example Client', 'stars-testimonials-with-slider-and-masonry-grid' ); ?>">
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="tst-form-field">
                    ...
                    <div class="tst-form-field-right">
                        <div class="testimonial-text-area">
                            ...
                            ?>
                            <div class="tst-placeholder" style="display: <?php echo empty($post->post_content)?"block":"none" ?>"><?php esc_html_e('Type in the testimonial here', 'stars-testimonials-with-slider-and-masonry-grid'); ?></div>
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="tst-form-field">
                    ...
                    <div class="tst-form-field-right">
                        <input type="text" value="<?php echo esc_attr($company_name) ?>" name="company_name" id="company_name" placeholder="<?php echo esc_attr__( 'Company Inc', 'stars-testimonials-with-slider-and-masonry-grid' ); ?>">
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="tst-form-field">
                    ...
                    <div class="tst-form-field-right">
                        <input type="text" value="<?php echo esc_attr($website_link) ?>" name="website_link" id="website_link" placeholder="<?php echo esc_attr__( 'https://www.example.com', 'stars-testimonials-with-slider-and-masonry-grid' ); ?>">
                    </div>
                    <div class="clear"></div>
                </div>
                <?php
                ...
                <div class="tst-form-field">
                    <div class="tst-form-field-left">
                        <label for="website_link"><?php esc_html_e('Client image', 'stars-testimonials-with-slider-and-masonry-grid'); ?></label>
                    </div>
                    <div class="tst-form-field-right">
                        ...
                        <div class="image-buttons">
                            ...
                            <button type="button" class="button button-secondary remove-image <?php echo (!empty($image_url))?"active":"" ?>"><?php esc_html_e('Remove image', 'stars-testimonials-with-slider-and-masonry-grid'); ?></button>
                        ...
                        <div class="select-box select-box-custom">
                            <select name="testimonial_categories[]" id="grid_categories" class="select-box select2" multiple="multiple" >
                                <?php foreach($terms as $term) {
                                    ...
                                    echo "<option " . esc_attr($selected) . " value='" . esc_attr($term->term_id) . "'>" . esc_html($term->name) . "</option>";
                                } ?>
                            </select>
                        </div>
                    </div>
                ...
                <input type="hidden" name="nonce" value="<?php echo esc_attr( wp_create_nonce("update_premio_testimonial_post_".$post_id) ) ?>" >
...
<script>
    ...
    jQuery("title").text("<?php echo esc_js( esc_html__( 'Update testimonial', 'stars-testimonials-with-slider-and-masonry-grid' ) ); ?>");
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on("click", ".upload-image", function(){
            var imageTst = wp.media({
                title: '<?php echo esc_js( esc_html__( 'Upload Image', 'stars-testimonials-with-slider-and-masonry-grid' ) ); ?>',
                multiple: false,
                library: {
                    type: 'image'
                }
        ...
        jQuery("#add_testimonial_item").submit(function(){
            ...
            jQuery(this).find(".required").each(function(){
               if(jQuery.trim(jQuery(this).val()) == "") {
                   ...
                   jQuery(this).after("<span class='error-message'>"+jQuery(this).attr("data-label")+" <?php echo esc_js( esc_html__( 'is required', 'stars-testimonials-with-slider-and-masonry-grid' ) ); ?></span>");
               }
            });
            ...
            if(errorCount == 0) {
                ...
                jQuery.post("<?php echo esc_url( admin_url("admin-ajax.php") ); ?>", data, function (response) {
                    ...
                    if(response.status == 1) {
                        ...
                        Swal.fire({
                            title: '<?php echo esc_js( esc_html__( 'Error!', 'stars-testimonials-with-slider-and-masonry-grid' ) ); ?>',
